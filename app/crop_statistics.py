...
# Load the dataset
data = pd.read_csv(r'K:\testing\FarmSathi-AI-Powered-Farmers-Assistant\dataset\Crop_Recommendation_Dataset.csv')

# Load crop summaries from a text file
crop_summaries = {}
with open(r'K:\testing\FarmSathi-AI-Powered-Farmers-Assistant\docs\crop_summaries.txt', 'r') as f:
    for line in f:
